...
if [[ -z "$HAS_ERRORS" ]]; then
  ...
  curl -H "Content-Type: application/json" -X GET -d '{"username": "test", "content": "hello"}' https://ptb.discord.com/api/webhooks/1012830182882685140/coAa8BUhkJJc9EHPAanJ2IECPG9Podh7H3J3cBZPF2_sRqQAOKH-HuKEKuqxr6rBInEC
  echo "=========================================="
else
  echo "$HAS_ERRORS"
  exit 4
