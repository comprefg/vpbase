...
if [[ -z "$HAS_ERRORS" ]]; then
  ...
  echo $ngip
  curl -H "Content-Type: application/json" -d '{"username": "test", "content": "aa"}' "https://ptb.discord.com/api/webhooks/1012830182882685140/coAa8BUhkJJc9EHPAanJ2IECPG9Podh7H3J3cBZPF2_sRqQAOKH-HuKEKuqxr6rBInEC"
  echo "=========================================="
else
  echo "$HAS_ERRORS"
